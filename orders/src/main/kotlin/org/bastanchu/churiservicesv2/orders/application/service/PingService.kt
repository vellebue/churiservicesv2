package org.bastanchu.churiservicesv2.orders.application.service

import org.bastanchu.churiservicesv2.orders.application.PingUseCase
...
class PingService(
    ...
    @Value("\${info.app.name:churiservices-orders}") private val applicationName: String
) : PingUseCase {
